...
page_title: "groundcover_metricsaggregator Resource - groundcover"
subcategory: ""
description: |-
  Metrics Aggregator resource. This is a singleton resource that configures metrics aggregation rules.
---

# groundcover_metricsaggregator (Resource)
...
- `value` (String) The YAML representation of the metrics aggregator configuration.

### Read-Only

- `updated_at` (String) The last update timestamp of the metrics aggregator configuration.
