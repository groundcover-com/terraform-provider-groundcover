...
*   **Metrics Aggregator Resource:** [`examples/resources/groundcover_metricsaggregator/resource.tf`](./examples/resources/groundcover_metricsaggregator/resource.tf)
...
TF_ACC=1 go test ./internal/provider -v -run TestAccMetricsAggregatorResource
